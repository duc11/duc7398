    ...
    <%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
        ...
        <li><a href="/home?lang=vi" data-lang="vi">Việt Nam</a></li>
        <li><a href="/home?lang=en" data-lang="en">English</a></li>
        </ul>
        </div>
...
<%--        <p>Giỏ hàng của bạn <br><b>Có <span id="count_shopping_cart_store">0</span> sản phẩm</b></p>--%>
        ...
        <a href="https://www.facebook.com/messages/t/100030680343840" id="goToMess" target="_blank"> <img src="/admin/images/customers/messenger-chat.png" alt="chat với shopDuc"> </a>
        </div>
