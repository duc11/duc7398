...
public interface ProductService {
    ...
    Page<Product> findByNameProduct(String name, Optional<Integer> page, Optional<Integer> size);

    List<Product> findProductId();

    List<Product> findByAzProduct();

    List<Product> findByQtProduct(Set<Long> id);

    Page<Product> findByNameContaining(String name, Pageable pageable);

    List<Product> getAllProductPC(Integer id);
